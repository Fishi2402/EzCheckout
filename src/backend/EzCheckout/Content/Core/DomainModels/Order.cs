...
public class Order {
    ...
    /// <summary>
    /// Initializes a new instance of an completed the <see cref="Order"/>..
    /// </summary>
    /// <param name="identifier">The unique identifier of the order.</param>
    /// <param name="created">The creation time of the order.</param>
    /// <param name="completed">The completion time of the order.</param>
    /// <param name="items">The items with there quantity of the order.</param>
    /// <param name="type">The type of the order.</param>
    public Order(
            int identifier,
            DateTime created,
    ...
    /// <summary>
    /// Gets the items with there quantity for the order.
    /// </summary>
